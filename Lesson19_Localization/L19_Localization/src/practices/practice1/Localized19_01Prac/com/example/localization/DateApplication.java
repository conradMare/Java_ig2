package practices.practice1.Localized19_01Prac.com.example.localization;
...
public class DateApplication {
    ...
    public void printMenu() {
        ...
        pw.println("q. " + messages.getString("menu q"));
        System.out.print(messages.getString("menu command") + " ");
    }
